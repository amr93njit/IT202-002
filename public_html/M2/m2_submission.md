...
<tr><td> <em>Generated: </em> 2/13/2022 12:48:46 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-002-S22/m2-php-hw/grade/amr93" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98342831/153766685-32fa2e97-5466-4e62-848b-a0ebdee6a31a.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing solution for problem 1<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>I used a for loop to iterate throughout each array and determined if<br>an element was odd with the modulus operator. If a value did not<br>return 0, that number was odd and was therefore output.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98342831/153766932-ad22760e-6835-4985-858d-6eeddb74611e.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing solution for problem 2<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>A for loop was used to iterate through each array and summated each<br>element to the $total variable. The round() function was used to the second<br>decimal place, but this does not work in cases where the rounded float<br>has 1 decimal place, such as in the case of 1.00 being output<br>as 1.0 in A3. To get around this, I used the number_format() function<br>to the second decimal place which retains the second decimal place at the<br>cost of converting the value to a string. This is a less than<br>ideal solution as the $total variable has been changed to a string from<br>its original float designation, which was done to not edit the preexisting echo<br>statement.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98342831/153767261-77c03e74-90a0-473b-8568-afd3264c2796.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing solution for problem 3<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>I used a for loop to iterate throughout each array and used the<br>abs function to output each element as a positive value.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://amr93-prod.herokuapp.com/M2/problem1.php">https://amr93-prod.herokuapp.com/M2/problem1.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://amr93-prod.herokuapp.com/M2/problem2.php">https://amr93-prod.herokuapp.com/M2/problem2.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://amr93-prod.herokuapp.com/M2/problem3.php">https://amr93-prod.herokuapp.com/M2/problem3.php</a> </td></tr>
<tr><td> <em>Sub-Task 4: </em> Pull Request URL for M2-PHP-HW to dev</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/amr93njit/IT202-002/pull/2">https://github.com/amr93njit/IT202-002/pull/2</a> </td></tr>
<tr><td> <em>Sub-Task 5: </em> Talk about what you learned, any issues you had, how you resolve them</td></tr>
<tr><td> <em>Response:</em> <p>I learned how to apply the structures of PHP that we have so<br>far gone over in-class and from the links on canvas. In particular, I<br>learned the most from completing assignment 2 in the way that round function<br>works. For some reason, the float function refuses to round to the second<br>decimal place or higher in a case where the value at hand has<br>no consecutive non-zero integers, such as in the case of 0.1 in A3.<br>Looking through documentation of PHP and finding the number_format() function (as well as<br>other functions, such as sprintf() and printf()) was key in solving problem 2.<br></p><br></td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-002-S22/m2-php-hw/grade/amr93" target="_blank">Grading</a></td></tr></table>
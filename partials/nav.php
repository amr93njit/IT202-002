...
<nav class="navbar navbar-expand-lg navbar-light bg-transparent">
    <div class="container-fluid">
        <a class="navbar-brand nav-link text-primary" href="<?php echo get_url('home.php'); ?>">Home</a></li>
        ...
        <div class="collapse navbar-collapse" id="navContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if (is_logged_in()) : ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu bg-light" aria-labelledby="rolesDropdown">
                            <li><a class="dropdown-item text-primary" href="<?php echo get_url('create_competition.php'); ?>">Create</a></li>
                            <li><a class="dropdown-item text-primary" href="<?php echo get_url('active_competitions.php'); ?>">Active</a></li>
                        </ul>
                    </li>    
                <?php endif; ?>
                ...
                <?php endif; ?>
                <?php if (is_logged_in()) : ?>
                    <li class="nav-item"><a class="nav-link text-primary" href="<?php echo get_url('logout.php'); ?>">Logout</a></li>
                <?php endif; ?>
            </ul>
        </div>
    </div>
